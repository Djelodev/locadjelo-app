...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $postimage = Image::make($image)->resize(1600, 980)->stream(); // FIX: was ->save()
        ...
        Toastr::success('message', 'Article créé avec succès.');
    ...
    public function update(Request $request, $post)
    {
        ...
        $image = $request->file('image');
        $slug  = str_slug($request->title);
        $post  = Post::find($post); // $post est un entier (paramètre de route)
        ...
        Toastr::success('message', 'Article mis à jour avec succès.');
        return redirect()->route('admin.posts.index');
    }
    ...
    public function destroy(Post $post)
    {
        ...
        Toastr::success('message', 'Article supprimé avec succès.');
        return back();
    }
}
