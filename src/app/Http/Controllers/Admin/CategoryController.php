...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $slider = Image::make($image)->resize(1600, 480)->stream(); // FIX: was ->save()
            Storage::disk('public')->put('category/slider/' . $imagename, $slider);

            if (!Storage::disk('public')->exists('category/thumb')) {
                Storage::disk('public')->makeDirectory('category/thumb');
            }
            $thumb = Image::make($image)->resize(500, 330)->stream(); // FIX: was ->save()
        ...
        Toastr::success('message', 'Catégorie créée avec succès.');
    ...
    public function update(Request $request, $category)
    {
        ...
        Toastr::success('message', 'Catégorie mise à jour avec succès.');
        return redirect()->route('admin.categories.index');
    }
    ...
    public function destroy($category)
    {
        ...
        Toastr::success('message', 'Catégorie supprimée avec succès.');
        return back();
    }
}
