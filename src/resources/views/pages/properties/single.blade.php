            ...
            <div class="row">
                <div class="col s12 m8">
                    ...
                    <div>
                        ...
                        <span class="btn btn-small disabled b-r-20">Chambre(s) : {{ $property->bedroom}} </span>
                        <span class="btn btn-small disabled b-r-20">Salle(s) de bain : {{ $property->bathroom}} </span>
                        <span class="btn btn-small disabled b-r-20">Surface : {{ $property->area}} m²</span>
                    </div>
                </div>
                <div class="col s12 m4">
                    <div>
                        <h4 class="left">${{ $property->price }}@if($property->type === 'apartment' && $property->purpose === 'rent')<small>/mois</small>  @endif</h4>
                        <button type="button" class="btn btn-small m-t-25 right disabled b-r-20"> {{ $property->purpose }}</button>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col s12 m8">
                    ...
                    <div>
                        @if($property->features)
                            <ul class="collection with-header">
                                <li class="collection-header grey lighten-4"><h5 class="m-0">Caractéristiques</h5></li>
                    ...
                    <div class="card-no-box-shadow card">
                        <div class="p-15 grey lighten-4">
                            <h5 class="m-0">
                                {{ $property->comments_count }} Commentaire(s)
                                @auth
                        ...
                        <div class="single-narebay p-15">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                ...
                                                @auth
                                                    <span id="commentreplay" class="right replay" data-commentid="{{ $comment->id }}">Répondre</span>
                                                @endauth
                            ...
                            @auth
                                <div class="comment-box">
                                    ...
                                    <form action="{{ route('property.comment',$property->id) }}" method="POST">
                                        ...
                                        <input type="submit" class="btn indigo" value="Commenter">
                                    </form>
                                </div>
                            @endauth
                            ...
                            @guest 
                                <div class="comment-login">
                                    ...
                                    <a href="{{ route('login') }}" class="btn indigo">Se connecter</a>
                                </div>
                            @endguest
                ...
                <div class="col s12 m4">
                    <div class="clearfix">
                        ...
                        <div>
                            <ul class="collection with-header m-t-0">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Contacter l'agent</h5>
                                </li>
                                <li class="collection-item p-0">
                                    @if($property->user)
                                        ...
                                        <div class="p-l-10 p-r-10">
                                            ...
                                            <a href="{{ route('agents.show',$property->agent_id) }}" class="profile-link">Profil</a>
                                        </div>
                                    @endif
                                </li>
                                ...
                                <li class="collection agent-message">
                                    <form class="agent-message-box" action="" method="POST">
                                        ...
                                        <div class="box">
                                            <input type="number" name="phone" placeholder="Votre téléphone">
                                        </div>
                                        <div class="box">
                        ...
                        <div>
                            <ul class="collection with-header">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Propriétés similaires</h5>
                                </li>
            ...
            .on("rateyo.set", function (e, data) {
                ...
                $.post( "{{ route('property.rating') }}", { rating: rating, property_id: property_id, user_id: user_id }, function( data ) {
                    if(data.rating.rating){
                        M.toast({html: 'Rating: '+ data.rating.rating + ' ajoutée avec succès.', classes:'green darken-4'})
                    }
                });
            });
                ...
                $('#procomment-'+commentid).empty().append(
                    `<div class="comment-box">
                        <form action="{{ route('property.comment',$property->id) }}" method="POST">
                            ...
                            <textarea name="body" class="box" placeholder="Laisser un commentaire"></textarea>
                            <input type="submit" class="btn indigo" value="Commenter">
                        </form>
                    </div>`
                );
            ...
            $(document).on('submit','.agent-message-box',function(e){
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $(btn).empty().append('CHARGEMENT...<i class="material-icons left">rotate_right</i>');
                    },
                    ...
                    complete: function() {
                        ...
                        $(btn).empty().append('ENVOYER<i class="material-icons left">send</i>');
                    },
                    dataType: 'json'
                });
