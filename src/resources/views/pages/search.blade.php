        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m4 card">
                    ...
                    <h2 class="sidebar-title">Recherche de bien</h2>
                    ...
                    <form class="sidebar-search" action="{{ route('search')}}" method="GET">
                        ...
                        <div class="searchbar">
                            <div class="input-field col s12">
                                ...
                                <label for="autocomplete-input-sidebar">Entrez une ville</label>
                            </div>
                            ...
                            <div class="input-field col s12">
                                <select name="bedroom" class="browser-default">
                                    <option value="" disabled selected>Nb. de chambres</option>
                            ...
                            <div class="input-field col s12">
                                <select name="bathroom" class="browser-default">
                                    <option value="" disabled selected>Nb. de salles de bain</option>
                            ...
                            <div class="input-field col s12">
                                ...
                                <label for="minarea">Surface minimum</label>
                            </div>

                            <div class="input-field col s12">
                                <input type="number" name="maxarea" id="maxarea" class="custominputbox">
                                <label for="maxarea">Surface maximum</label>
                            </div>
                            ...
                            <div>
                                <div class="card-content property-content">
                                    ...
                                    <h5>
                                        ...
                                        <small class="right">{{ $property->type }} — {{ $property->purpose }}</small>
                                    </h5>
