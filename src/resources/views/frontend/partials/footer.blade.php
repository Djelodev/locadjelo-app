    ...
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                <h5 class="white-text uppercase">À propos</h5>
                @if(isset($footersettings[0]) && $footersettings[0]['aboutus'])
                    <p class="grey-text text-lighten-4">{{ $footersettings[0]['aboutus'] }}</p>
                @else
                    <p class="grey-text text-lighten-4">Chez LOCADJELO, nous mettons en relation acheteurs, vendeurs et locataires avec des annonces immobilières de confiance. Notre mission est de rendre la recherche de bien simple, fiable et adaptée à votre style de vie.</p>
                @endif
            </div>
            <div class="col m6 s12">
                <h5 class="white-text uppercase">Propriétés récentes</h5>
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        ...
                        <div class="float-left">
                            ...
                            <p class="m-t-0 m-b-5 grey-text text-lighten-1">Chambre(s) : {{ $property->bedroom }} &nbsp; Salle(s) de bain : {{ $property->bathroom }}</p>
                        </div>
                    </li>
                    @endforeach
                </ul>
            ...
            <div class="col m2 s12">
                ...
                <ul>
                    <li class="uppercase {{ Request::is('property*') ? 'underline' : '' }}">
                        <a href="{{ route('property') }}" class="grey-text text-lighten-3">Propriétés</a>
                    </li>
