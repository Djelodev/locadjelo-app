<div class="navbar-fixed">
        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    @guest
                        <li><a href="{{ route('login') }}" title="Connexion"><i class="material-icons">input</i></a></li>
                        <li><a href="{{ route('register') }}" title="Inscription"><i class="material-icons">person_add</i></a></li>
                    @else
                        <li>
    ...
    <ul class="sidenav" id="mobile-demo">
        ...
        <li class="{{ Request::is('property*') ? 'active' : '' }}"><a href="{{ route('property') }}">Propriétés</a></li>
        <li class="{{ Request::is('agents*') ? 'active' : '' }}"><a href="{{ route('agents') }}">Agents</a></li>
        <li class="{{ Request::is('gallery') ? 'active' : '' }}"><a href="{{ route('gallery') }}">Galerie</a></li>
