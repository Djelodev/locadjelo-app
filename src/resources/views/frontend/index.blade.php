...
@section('content')
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">Propriétés en vedette</h4>
            </div>
            <div class="row">
                        ...
                        <div class="card">
                            <div class="card-image">
                                ...
                                @if($property->featured == 1)
                                    <a class="btn-floating halfway-fab waves-effect waves-light indigo" title="En vedette"><i class="small material-icons">star</i></a>
                                @endif
                            </div>
                            <div class="card-content property-content">
                                ...
                                <div class="address">
                                    ...
                                    <span>{{ ucfirst($property->type) }} — {{ $property->purpose }}</span>
                                </div>
                                <h5>
    ...
    <section class="section grey lighten-3 center">
        <div class="container">
            <h4 class="section-heading">Témoignages</h4>
    ...
    <section class="section center">
        <div class="row">
            <h4 class="section-heading">Blog récent</h4>
        </div>
        <div class="container">
            <div class="row">
